...
GET:
	...
	PsCameraExtrinsicParameters * pCameraExtrinsicParameters = new PsCameraExtrinsicParameters;
	status = Ps2_GetCameraExtrinsicParameters(deviceHandle,sessionIndex,pCameraExtrinsicParameters);
	if (status != PsReturnStatus::PsRetOK)
	{
		cout << "Ps2_GetCameraExtrinsicParameters failed status:" << status << endl;
		return -1;
	}
	cout << "rotation:"<<endl;
	for (int i = 0; i < 9; i++)
	{
		cout << pCameraExtrinsicParameters->rotation[i] <<" "<<endl;
	}

	cout << "translation:"<<endl;
	for (int i = 0; i < 3; i++)
	{
		cout << pCameraExtrinsicParameters->translation[i] << " "<<endl;
	}
	cout << endl;
