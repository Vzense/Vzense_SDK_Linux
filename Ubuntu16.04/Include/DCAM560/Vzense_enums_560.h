#ifndef VZENSE_ENUMS_560_H
#define VZENSE_ENUMS_560_H
...
typedef enum{
	...
	PsDepthAndIRAndRGB_30 = 2,      //!< Outputs both depth and IR frames and RGB frame at 30 fps. The resolution for both depth and IR frames is 640*480.\n 
	                                //!< The resolution of and RGB frame can be set using ::PsSetFrameMode(), which supports 1600*1200/800*600/640*480.
